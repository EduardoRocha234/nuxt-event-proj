				...
				<div class="flex flex-col h-full">
					<div class="flex items-center justify-between px-6 pt-4 shrink-0">
						...
						<span>
							<button
								type="button"
								class="p-3 flex items-center justify-center rounded-full border cursor-pointer"
								@click="closeCallback"
							>
								<Icon
									name="mdi:remove"
					...
					<div class="overflow-y-auto py-10">
						<ul>
							<li>
								<a
									class="flex gap-3 items-center cursor-pointer p-4 rounded text-surface-700"
								>
									<Icon
										name="mi:user"
										size="20"
...
const sideBarVisible = defineModel('visible', {default: false})
